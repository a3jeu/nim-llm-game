...
class LLM(ABC):
    ...
    def __init__(self, model_name: str, temperature: float):
        """
        Initialize model configuration and placeholders.
        """
...
class Human(LLM):
    """
    A class to represent a human player - no AI involved
    """
    ...
    def __init__(self, model_name: str, temperature: float):
        """
        Create a new instance for a human player
        """
        super().__init__(model_name, temperature)
        self.client = None
    ...
    def _send(self, system: str, user: str, max_tokens: int = 3000) -> str:
        """
        For human players, we don't send to an AI - this should not be called directly.
        The UI will handle getting input from the human.
        """
        # This should never be called in normal flow
        return "{}"
